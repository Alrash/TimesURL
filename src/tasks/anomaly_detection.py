...
def eval_anomaly_detection(model, all_train_data, all_train_labels, all_train_timestamps, all_test_data,
    ...
    for i, k in enumerate(all_train_data):
        ...
        all_train_repr[k] = full_repr[:train_data.shape[1]]
        all_test_repr[k] = full_repr[train_data.shape[1]:]
        ...
        all_train_repr_wom[k] = full_repr_wom[:train_data.shape[1]]
        all_test_repr_wom[k] = full_repr_wom[train_data.shape[1]:]
